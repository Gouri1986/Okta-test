    ...
    >
      <div className="wp-100">
        <div className="flex-r-jc-ac">
          {item.id !== "cb" && item.id !== "action" && item.id !== "Severity" && (
        ...
        {item.id === "Severity" && (
          <div className="flex-r-ac flex-jc-sp-btn pl-5 pr-5 pt-5 severity-sb-header">
            <div
              onClick={e => {
            ...
            >
              <TableHeaderSortDownArrow up={sort.id === "confidentialityRisk" && sort.dir === "asc"} />
            ...
            >
              <TableHeaderSortDownArrow up={sort.id === "integrityRisk" && sort.dir === "asc"} />
            ...
            >
              <TableHeaderSortDownArrow up={sort.id === "availabilityRisk" && sort.dir === "asc"} />
...
const TableHeader = ({ header, tableData, headerStaticVisbility }) => {
  ...
  return (
    <tr className={"pb-0 pos-sk t-0 z-1 flex-r-ac titan-table-header  flex-jc-sp-evn "}>
      {header?.map(item => (
        <TableHeaderCell
          header={header}
          sort={sort}
