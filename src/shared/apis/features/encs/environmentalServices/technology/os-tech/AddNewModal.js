...
const [token, setToken] = useState(
  ...
  const handlePost = (evt) => {
    ...
    axios.post(`${process.env.REACT_APP_URL}/api/v1/encs-os-tech-master`, {
  ...
  return ( 
    ...
    >
      <ModalHeader className='mb-3' toggle={handleModal} close={CloseBtn} tag='div'>
        <h5 className='modal-title'style={{color:'black'}}>New OS Technology Master</h5>
      </ModalHeader>
      <ModalBody className='flex-grow-1' onSubmit={handleSubmit(onSubmit)}>
      <FormGroup>
          <Label for='OsCategoryName' style={{fontSize:'1rem'}}>Os technology name</Label>
          <InputGroup>
        ...
        <FormGroup>
          <Label for='OsCategorytag' style={{fontSize:'1rem'}}>Os Technology Tag</Label>
          <InputGroup>
            <InputGroupAddon addonType='prepend'>
              <InputGroupText>
              <Command size={15}/>
