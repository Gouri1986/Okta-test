...
useEffect(() => { 
  // if (isLoaded === false) {
    axios.get(`${process.env.REACT_APP_URL}/api/v1/encs-customer-location-info`,
    {
      headers: {               
...
//--Delete method-
const removeData = (customerLocationId) => {
  const DeletePassFunction = (data) => {
    const deletevar = data
    console.log("deletevar = ", deletevar)
    axios.delete(`${process.env.REACT_APP_URL}/api/v1/encs-customer-location-info`,
    {
        headers: {               
          "Content-Type": "application/json",
          "access-token": `${token}`
        },
        data : { customerLocationId : deletevar }
      }
      ).then((response) => {
  ...
  handleConfirmText(customerLocationId, {DeletePassFunction}) 
}
 const columns = [
  {
    name: 'Customer',
  ...
  },
  {
    ...
    cell: row => (
      <div className='d-flex align-items-center'>
        <div className='user-info text-truncate '>
          <span className='d-block font-weight-bold text-truncate'>{row.customerLocationPhone1}</span>
          {/* <small>{row.post}</small> */}
        </div>
      </div>
    )
  },
  {
    ...
    cell: row => (
      <div className='d-flex align-items-center'>
        <div className='user-info text-truncate '>
          <span className='d-block font-weight-bold text-truncate'>{row.customerLocationPhone2}</span>
          {/* <small>{row.post}</small> */}
        </div>
      </div>
    )
  },
  {
    ...
    cell: row => (
      <div className='d-flex align-items-center'>
        <div className='user-info text-truncate '>
          <span className='d-block font-weight-bold text-truncate'>{row.customerLocationEmail1}</span>
          {/* <small>{row.post}</small> */}
        </div>
      </div>
    )
  },
  {
    ...
    cell: row => (
      <div className='d-flex align-items-center'>
        <div className='user-info text-truncate '>
          <span className='d-block font-weight-bold text-truncate'>{row.customerLocationEmail2}</span>
          {/* <small>{row.post}</small> */}
        </div>
      </div>
    )
      ...
      return (
        <div className='d-flex'>
            <div tag='a' className='w-100'
              ...
              <div tag='a'  className='w-100'  onClick={() => removeData(row.customerLocationId)}>
                <Trash size={15} />
              </div>
    ...
    <Fragment>
      <Card>
        <CardHeader className="flex-md-row flex-column align-md-items-center align-items-start border-bottom">
          <CardTitle tag="h4" style={{ color: 'white'}}>Customer Location Details</CardTitle>
