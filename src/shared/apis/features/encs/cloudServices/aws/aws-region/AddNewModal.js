...
const AddNewModal = ({ open, handleModal, fetchData }) => {
  ...
  const handlePost = (evt) => {
    axios.post(`${process.env.REACT_APP_URL}/api/v1/encs-aws-region-details`, {
      regionId: regionid,
      cloudName: cloudname,
  ...
  return (
    ...
    >
      <ModalHeader className='mb-3' toggle={handleModal} close={CloseBtn} tag='div'>
        <h5 className='modal-title' style={{ color: 'black' }}>New AWS Region Details </h5>
      </ModalHeader>
      <ModalBody className='flex-grow-1' onSubmit={handleSubmit(onSubmit)}>
        ...
        <FormGroup>
          ...
          <InputGroup>
            ...
            <Input type='select' name='select' id='cloudName' onChange={changeSelectOptionHandlercloudName}>
