...
const DataTableWithButtons = () => {
  ...
  useEffect(() => {
    // if (isLoaded === false) {
    axios.get(`${process.env.REACT_APP_URL}/api/v1/encs-aws-region-details`,
      {
        headers: {
  ...
  const removeData = (regionId) => {
    const DeletePassFunction = (data) => {
      ...
      axios.delete(`${process.env.REACT_APP_URL}/api/v1/encs-aws-region-details`,
        {
          headers: {
            "Content-Type": "application/json",
            "access-token": `${token}`
  ...
  const columns = [
    ...
    {
      name: 'Address 1',
      selector: 'regionLoactionAddress1',
      sortable: true,
      minWidth: '200px',
      cell: row => (
        <div className='d-flex align-items-center'>
    ...
    {
      name: 'Address 2',
      selector: 'regionLoactionAddress2',
      sortable: true,
      minWidth: '200px',
      omit: address2,
      cell: row => (
    ...
    {
      name: 'Address 3',
      selector: 'regionLoactionAddress3',
      sortable: true,
      minWidth: '200px',
      omit: address3,
      cell: row => (
  ...
  return (
    <Fragment>
      <Breadcrumbs
        breadCrumbTitle='Region Details'
        breadCrumbParent='AWS'
        breadCrumbActive='Region Details'
      />
