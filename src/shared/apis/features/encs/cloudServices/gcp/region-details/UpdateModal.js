...
console.log(customerstate)
  ...
  const handlePost = (evt) => {
    axios.put(`${process.env.REACT_APP_URL}/api/v1/encs-gcp-region-details`, {
      regionId:regionid,
      cloudName: cloudname,
...
return (
    ...
    >
      <ModalHeader className='mb-3' toggle={handleUpdateModal} close={CloseBtn} tag='div'>
        <h5 className='modal-title'style={{color:'black'}}>Update GCP Region Details</h5>
      </ModalHeader>
      ...
      <FormGroup>
        ...
        <InputGroupAddon addonType='prepend'>
          ...
          <Input type='select' name='Cloudname' id='Cloudname'
          value={cloudname}
          onChange={changeSelectOptionHandlercloudName}>
      ...
      <FormGroup>
        ...
        <FormGroup>
          ...
          <InputGroup>
            ...
            <Input id='Pincode'
            value={pincode}
            onChange={(e) => setsetpincode(e.target.value)} />
          </InputGroup>
        </FormGroup>
        <FormGroup>
