...
const DataTableWithButtons = () => {
  ...
  useEffect(() => {
    // if (isLoaded === false) {
    axios.get(`${process.env.REACT_APP_URL}/api/v1/encs-oci-region-details`,
      {
        headers: {
  ...
  //-----------------------------------------Delete method----------------------------------------------------------------------
  const removeData = (regionId) => {
    const DeletePassFunction = (data) => {
      const deletevar = data
      console.log("deletevar = ", deletevar)
      axios.delete(`${process.env.REACT_APP_URL}/api/v1/encs-oci-region-details`,
        {
          headers: {
            "Content-Type": "application/json",
            "access-token": `${token}`
          },
          data: { regionId: deletevar }
        }
      ).then((response) => {
    ...
    handleConfirmText(regionId, { DeletePassFunction })
  }
  //-----------------------------------------Delete method End----------------------------------------------------------------------
  ...
  const columns = [
      ...
      cell: row => (
        <div className='d-flex align-items-center'>
          <div className='user-info text-truncate '>
            <span className='d-block font-weight-bold text-truncate' style={{ width: '150px' }}>{row.regionId}</span>
    ...
    },
    {
      ...
      selector: 'regionLocation',
      sortable: true,
      minWidth: '200px',
      cell: row => (
        <div className='d-flex align-items-center'>
          <div className='user-info text-truncate '>
            <span className='d-block font-weight-bold text-truncate'>{row.regionLocation}</span>
            {/* <small>{row.post}</small> */}
          </div>
        </div>
      )
    ...
    {
      name: 'Address 1',
      selector: 'regionLocationAddress1',
      sortable: true,
      minWidth: '200px',
      cell: row => (
        <div className='d-flex align-items-center'>
          <div className='user-info text-truncate '>
            <span className='d-block font-weight-bold text-truncate' style={{ width: '150px' }}>{row.regionLocationAddress1}</span>
            {/* <small>{row.post}</small> */}
          </div>
        </div>
      )
    ...
    {
      name: 'Address 2',
      selector: 'regionLocationAddress2',
      sortable: true,
      minWidth: '200px',
      omit: address2,
      cell: row => (
        <div className='d-flex align-items-center'>
          <div className='user-info text-truncate '>
            <span className='d-block font-weight-bold text-truncate' style={{ width: '150px' }}>{row.regionLocationAddress2}</span>
            {/* <small>{row.post}</small> */}
          </div>
        </div>
      )
    ...
    {
      name: 'Address 3',
      selector: 'regionLocationAddress3',
      sortable: true,
      minWidth: '200px',
      omit: address3,
      cell: row => (
        <div className='d-flex align-items-center'>
          <div className='user-info text-truncate '>
            <span className='d-block font-weight-bold text-truncate' style={{ width: '150px' }}>{row.regionLocationAddress3}</span>
            {/* <small>{row.post}</small> */}
          </div>
        </div>
      )
    },
    {
      ...
      cell: row => (
        <div className='d-flex align-items-center'>
          <div className='user-info text-truncate '>
            <span className='d-block font-weight-bold text-truncate'>{row.regionCity}</span>
            {/* <small>{row.post}</small> */}
          </div>
        </div>
      )
    ...
    {
      name: 'Region Pincode',
      selector: 'regionCityPincode',
      sortable: true,
      minWidth: '200px',
      cell: row => (
        <div className='d-flex align-items-center'>
          <div className='user-info text-truncate '>
            <span className='d-block font-weight-bold text-truncate'>{row.regionCityPincode}</span>
            {/* <small>{row.post}</small> */}
          </div>
        </div>
      )
    },
    {
      ...
      cell: row => (
        <div className='d-flex align-items-center'>
          <div className='user-info text-truncate '>
            <span className='d-block font-weight-bold text-truncate'>{row.regionState}</span>
            {/* <small>{row.post}</small> */}
          </div>
        </div>
      )
    ...
    {
      name: 'Country',
      selector: 'regionCountry',
      sortable: true,
      minWidth: '150px',
      cell: row => (
        <div className='d-flex align-items-center'>
          <div className='user-info text-truncate '>
            <span className='d-block font-weight-bold text-truncate'>{row.regionCountry}</span>
            {/* <small>{row.post}</small> */}
          </div>
        </div>
      )
    ...
    {
      name: 'Country Code',
      selector: 'regionCountryCode',
      sortable: true,
      minWidth: '180px',
      cell: row => (
        <div className='d-flex align-items-center'>
          <div className='user-info text-truncate '>
            <span className='d-block font-weight-bold text-truncate'>{row.regionCountryCode}</span>
            {/* <small>{row.post}</small> */}
          </div>
        </div>
      )
    ...
    {
      name: 'Primary Phone',
      selector: 'regionPrimaryPhone',
      sortable: true,
      minWidth: '200px',
      cell: row => (
        <div className='d-flex align-items-center'>
          <div className='user-info text-truncate '>
            <span className='d-block font-weight-bold text-truncate'>{row.regionPrimaryPhone}</span>
            {/* <small>{row.post}</small> */}
          </div>
        </div>
      )
...

    {
      ...
      cell: row => (
        <div className='d-flex align-items-center'>
          <div className='user-info text-truncate '>
            <span className='d-block font-weight-bold text-truncate'>{row.regionSecondaryPhone}</span>
            {/* <small>{row.post}</small> */}
          </div>
        </div>
      )
    ...
    {
      name: 'Primary Email',
      selector: 'regionPrimaryEmail',
      sortable: true,
      minWidth: '200px',
      cell: row => (
        <div className='d-flex align-items-center'>
          <div className='user-info text-truncate '>
            <span className='d-block font-weight-bold text-truncate'>{row.regionPrimaryEmail}</span>
            {/* <small>{row.post}</small> */}
          </div>
        </div>
      )
    },
    {
      ...
      cell: row => (
        <div className='d-flex align-items-center'>
          <div className='user-info text-truncate '>
            <span className='d-block font-weight-bold text-truncate'>{row.regionSecondaryEmail}</span>
            {/* <small>{row.post}</small> */}
          </div>
        </div>
      )
      ...
      cell: row => {
        return (
          <div className='d-flex' style={{ cursor: 'pointer' }}>
            ...
            <div tag='a' className='w-100' onClick={() => removeData(row.regionId)}>
              <Trash size={15} />
            </div>
          </div>
        )
  ...
  const handleFilter = e => {
    ...
    if (value.length) {
      updatedData = data.filter(item => {
        try {
          const startsWith =
            item.regionLocation.toLowerCase().startsWith(value.toLowerCase()) ||
            item.regionLocationAddress1.toLowerCase().startsWith(value.toLowerCase()) ||
            item.regionCity.toLowerCase().startsWith(value.toLowerCase()) ||
            item.regionId.toLowerCase().startsWith(value.toLowerCase()) ||
            item.cloudName.toLowerCase().startsWith(value.toLowerCase()) ||
            item.regionCountry.toLowerCase().startsWith(value.toLowerCase())

          const includes =
            item.regionLocation.toLowerCase().includes(value.toLowerCase()) ||
            item.regionLocationAddress1.toLowerCase().includes(value.toLowerCase()) ||
            item.regionCity.toLowerCase().includes(value.toLowerCase()) ||
            item.regionId.toLowerCase().includes(value.toLowerCase()) ||
            item.cloudName.toLowerCase().includes(value.toLowerCase()) ||
            item.regionCountry.toLowerCase().includes(value.toLowerCase())
  ...
  return (
    <Fragment>
      <Breadcrumbs breadCrumbTitle='Oracle Cloud Region Details' breadCrumbParent='Oracle Cloud
' breadCrumbActive='Oracle Cloud Region Details' />
