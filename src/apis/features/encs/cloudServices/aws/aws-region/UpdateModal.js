...
console.log(customerstate)
  ...
  const handlePost = (evt) => {
    axios.put(`${process.env.REACT_APP_URL}/api/v1/encs-aws-region-details`, {
      regionId:regionid,
      cloudName: cloudname,
...
return (
    ...
    >
      <ModalHeader className='mb-3' toggle={handleUpdateModal} close={CloseBtn} tag='div'>
        <h5 className='modal-title'style={{color:'black'}}>Update AWS Region Details </h5>
      </ModalHeader>
      ...
      <FormGroup>
        ...
        <InputGroupAddon addonType='prepend'>
          ...
          <Input type='select' name='select' id='cloudName'
          value={cloudname}
